...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Revenio is an AI-powered parallel-universe simulation platform. Forge a new self, choose a world, and live a story that was never yours." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Revenio — Explore the Life You Never Lived" },
      { name: "twitter:description", content: "Revenio is an AI-powered parallel-universe simulation platform. Forge a new self, choose a world, and live a story that was never yours." },
